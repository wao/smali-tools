...
token_list=%w[ DIR_METHOD END_METHOD DIR_CLASS DIR_LOCAL DIR_LOCALS DIR_SOURCE DIR_ANNOTATION END_ANNOTATION DIR_SUPER CLASSNAME ID LEFT_PAREN RIGHT_PAREN LEFT_BRACE RIGHT_BRACE]

File.open("Re2cTokenType.txt", "w") do |txt|
